...
package com.fever.feverapp.youtubeEXT;

import static android.view.ViewGroup.LayoutParams.MATCH_PARENT;
import static android.view.ViewGroup.LayoutParams.WRAP_CONTENT;

import com.fever.feverapp.handlers.DeveloperKey;
import com.fever.feverapp.handlers.YouTubeFailureRecoveryActivity;
...
public class FullscreenDemoActivity extends YouTubeFailureRecoveryActivity implements
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    playerView.initialize(DeveloperKey.getDeveloperKey(), this);
